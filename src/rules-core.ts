...
/**
 * Validate an already-parsed rule pack object (no filesystem access).
 * Useful in browser/playground contexts where the JSON comes from a textarea
 * rather than a file path. Throws descriptive validation errors.
 */
export function parseRulePack(value: unknown): RulePack {
